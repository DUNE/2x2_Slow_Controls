...
{
    field(DTYP,"Snmp")
    field(INP,"@$(HOST) $(COMMUNITY) $(W)::outputMeasurementTerminalVoltage.u$(channel) Float: 100")
    field(SCAN,".2 second")
    field(EGU,"V")
...
{
    field(DTYP,"Snmp")
    field(OUT,"@$(HOST) $(COMMUNITY) $(W)::outputTripTimeMaxCurrent.u$(channel) INTEGER: 100 i")
    field(SCAN,"Passive")
    field(EGU,"msec")
...
{
    field(DTYP,"Snmp")
    field(OUT,"@$(HOST) $(COMMUNITY) $(W)::outputVoltageRiseRate.u$(channel) Float: 100 F")
    field(SCAN,"Passive")
    field(EGU,"V/sec")
...
{
    field(DTYP,"Snmp")
    field(OUT,"@$(HOST) $(COMMUNITY) $(W)::outputVoltageFallRate.u$(channel) Float: 100 F")
    field(SCAN,"Passive")
    field(EGU,"V/sec")
...
# {
#     field(DTYP,"Snmp")
#     field(OUT,"@$(HOST) $(COMMUNITY) $(W)::outputSupervisionMaxSenseVoltage.u$(channel) Float: 100 F")
#     field(SCAN,"Passive")
#     field(EGU,"V")
