...
*/
  ...
  if (strcasecmp(param,"privType") == 0) {
    ...
    if (strcasecmp(value, "DES") == 0) {
      ...
      #endif
      #endif // == by Sungbin based on https://github.com/Cacti/spine/pull/258/files
    } else if ((strcasecmp(value, "AES") == 0) || (strcasecmp(value, "AES128") == 0)) {

      //if ((strcasecmp(value, "AES") == 0) || (strcasecmp(value, "AES128") == 0)) { // == by Sungbin
